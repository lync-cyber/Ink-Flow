...
**规则 3 — 标题党规避**: 命中下列模式 → warning（非强制阻断，提示用户确认）
- 震惊体: "惊呆了"、"震惊"、"万万没想到"、"太可怕了"、"不得不看"
- 过度反转: "你以为的 X 其实都是错的"、"99% 的人都不知道"
- 绝对化承诺: "必看"、"速收藏"、"史上最全"、"一文搞定"、"零基础也能"
- 空洞标签: "深度揭秘"、"干货满满"、"纯干货"
- 情绪绑架: "再不 X 就晚了"、"还不知道就 out 了"
- 数字暴力: 超过 3 个数字 / 多数字并列（"3 种方法 10 个技巧 5 个坑"）

...
Usage:
    python tools/render/svg-sanitize.py input.svg                  # sanitize in-place
    python tools/render/svg-sanitize.py input.svg -o output.svg    # write to new file
    python tools/render/svg-sanitize.py input.svg --check-only     # report issues, exit 1 if any
    cat input.svg | python tools/render/svg-sanitize.py -           # read from stdin, write to stdout
"""
